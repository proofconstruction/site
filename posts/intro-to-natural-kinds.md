---
title: Introduction to Natural Kinds
date: 2021-06-30
---
...
For example, in the category of groups $Grp$, all and only algebraic groups are present in the object class $Ob(Grp)$, and every $G$ in $Ob(Grp)$ satisfies a family of properties called the [group axioms](https://proofwiki.org/wiki/Definition:Group_Axioms).
